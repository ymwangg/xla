...
def parse_common_options(datadir=None,
  ...
  parser.add_argument('--xla_enabled', action='store_true')
  # parser.add_argument('--amp', action='store_true')
  parser.add_argument('--dlprof_enabled', action='store_true')
  parser.add_argument('--xla_debug_metrics_enabled', action='store_true')
